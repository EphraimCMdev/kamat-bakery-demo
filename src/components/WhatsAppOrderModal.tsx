          ...
          <div>
            ...
            {selectedType === 'direct' && (
              <div className="p-4 rounded-2xl bg-[#EDE4DC]/70 border border-[#E2D5C8] mb-6 text-xs text-[#3D2E2A] leading-relaxed animate-in fade-in duration-200">
                💬 <span className="font-bold text-[#120E0D]">Instant WhatsApp Enquiry:</span> You will connect directly with our baking desk in Dharwad to discuss flavors, same-day cake availability, and pickup times.
              </div>
            )}

          </div>

          {/* Final Action CTA Button in Kamat Yellow */}
